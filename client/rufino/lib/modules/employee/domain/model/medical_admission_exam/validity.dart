...
class Validity extends TextPropBase {
  ...
  const Validity(String value) : super("Validade do exame", value);

  const Validity.empty() : super("Validade do exame", "");

  factory Validity.createFormatted(String number) => Validity(format(number));
  ...
  @override
  Validity copyWith({String? value}) {
    return Validity(value ?? this.value);
  }
  ...
  String? validate(String? value) {
    ...
    try {
      ...
      var dateMax = DateTime.now().add(const Duration(days: 3650));
