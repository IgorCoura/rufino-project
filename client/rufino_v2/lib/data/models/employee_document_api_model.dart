...
class DocumentUnitApiModel {
  ...
  /// Converts `dd/MM/yyyy` to an ISO 8601 UTC string for the API.
  static String dateToIsoUtc(String ddMMyyyy) {
    if (ddMMyyyy.isEmpty || ddMMyyyy.length != 10) return ddMMyyyy;
    final parts = ddMMyyyy.split('/');
    if (parts.length != 3) return ddMMyyyy;
    ...
    if (day == null || month == null || year == null) return ddMMyyyy;
    return DateTime(year, month, day).toUtc().toIso8601String();
  }
}
