...
/// <summary>
/// CPF ou CNPJ com dígito verificador conferido. É a identidade fiscal do tenant, e a
/// única coisa que distingue pessoa física de jurídica no cadastro.
/// </summary>
public sealed class TaxId : ValueObject
{
    ...
    /// <summary>
    /// Deduz CPF ou CNPJ pela quantidade de dígitos. O formulário de cadastro manda o
    /// documento sem rótulo, e deixar a camada de cima adivinhar o tipo espalharia a
    /// regra dos 11/14 dígitos por toda a Application.
    /// </summary>
    ...
    {
        // Reject repeated-digit values (11111111111 and friends): formal length matches, document does not exist.
