...
/// <summary>Identidade do <see cref="CaptureItem"/>.</summary>
/// <remarks>
...
/// </remarks>
public readonly record struct CaptureItemId(Guid Value)
    : IEntityId<CaptureItemId>, IComparable<CaptureItemId>
{
    ...
    public int CompareTo(CaptureItemId other) => Value.CompareTo(other.Value);

    public static bool operator <(CaptureItemId left, CaptureItemId right) => left.CompareTo(right) < 0;
    public static bool operator >(CaptureItemId left, CaptureItemId right) => left.CompareTo(right) > 0;
    public static bool operator <=(CaptureItemId left, CaptureItemId right) => left.CompareTo(right) <= 0;
    public static bool operator >=(CaptureItemId left, CaptureItemId right) => left.CompareTo(right) >= 0;
}
