...
| **2.6** | `RoutingRule` + `BillRoutingService` (escada de 5 degraus, incluindo o **degrau 0 por senha derivada**); promoção automática; quarentena; reivindicação criando regra; check `TenantRouting` |
