...
namespace BillPayment.Infra.Migrations
{
    ...
    [Migration("20260914205945_CaptureItemAccountReferenceMemory")]
    partial class CaptureItemAccountReferenceMemory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BillPayment.Domain.Bills.Bill", b =>
                {
                    ...
                    b.Property<int>("RevalidationAttempts")
                        .HasColumnType("integer")
                        .HasColumnName("revalidation_attempts");

                    b.Property<DateTime?>("RevalidationNextAttemptAt")
                        .HasColumnType("timestamp with time zone")
            ...
            modelBuilder.Entity("BillPayment.Domain.CaptureItems.CaptureItem", b =>
                {
                    ...
                    b.Property<string>("AccountReferenceSuggestion")
                        .HasMaxLength(100)
                    ...
                    b.Property<string>("RememberedAccountReference")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
            ...
            modelBuilder.Entity("BillPayment.Domain.PayerProfiles.PayerProfile", b =>
                {
                    ...
                    b.Property<DateTime?>("AsaasWebhookRotatedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("asaas_webhook_rotated_at");
            ...
            modelBuilder.Entity("BillPayment.Domain.PaymentOrders.PaymentOrder", b =>
                {
                    ...
                    b.Property<bool>("ReceiptUnavailable")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                    ...
                    b.Property<DateTime?>("SweepAttemptedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("sweep_attempted_at");
            ...
            modelBuilder.Entity("BillPayment.Infra.Persistence.PaymentWebhookEvent", b =>
                {
                    ...
                    b.ToTable("payment_webhook_events", "bill_payment");
                });
                    ...
                    b.OwnsOne("BillPayment.Domain.Bills.ApprovalRecord", "Approval", b1 =>
                        {
                            ...
                            b1.Property<decimal?>("AmountAtDecision")
                                .HasPrecision(18, 2)
