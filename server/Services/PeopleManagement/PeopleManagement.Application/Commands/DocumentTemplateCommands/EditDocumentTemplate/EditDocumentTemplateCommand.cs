...
namespace PeopleManagement.Application.Commands.DocumentTemplateCommands.EditDocumentTemplate
{
    ...
    public record EditDocumentTemplateCommand(Guid Id, Guid CompanyId, string Name, string Description, EditTemplateFileInfoModel? TemplateFileInfo, double? DocumentValidityDurationInDays, double? WorkloadInHours, bool AcceptsSignature, EditPlaceSignatureModel[] PlaceSignatures, Guid DocumentGroupId, bool UsePreviousPeriod = false, PoliciesModel? Policies = null) : IRequest<EditDocumentTemplateResponse>
    {
    }

    public record EditDocumentTemplateModel(Guid Id, string Name, string Description, EditTemplateFileInfoModel? TemplateFileInfo, double? DocumentValidityDurationInDays, double? WorkloadInHours, bool AcceptsSignature, EditPlaceSignatureModel[] PlaceSignatures, Guid DocumentGroupId, bool UsePreviousPeriod = false, PoliciesModel? Policies = null)
    {
        public EditDocumentTemplateCommand ToCommand(Guid company) => new(Id, company, Name, Description, TemplateFileInfo, DocumentValidityDurationInDays, WorkloadInHours, AcceptsSignature, PlaceSignatures, DocumentGroupId, UsePreviousPeriod, Policies);
    }
