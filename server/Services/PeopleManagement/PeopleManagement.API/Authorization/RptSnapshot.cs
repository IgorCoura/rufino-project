...
namespace PeopleManagement.API.Authorization
{
    ...
    /// (<c>"esta pessoa tem employee#edit?"</c>), uma pergunta por TOKEN (<c>"o que esta pessoa
    ...
    /// </para>
    /// <para>
    /// <strong>Um retrato vazio é resposta válida</strong>, não erro: é o que o servidor devolve
    /// para quem está autenticado e não tem permissão nenhuma. Quem distingue "sem permissão" de
    /// "não consegui perguntar" é o <see cref="RptFetchOutcome"/>, não este tipo.
    /// </para>
    /// </remarks>
    public sealed class RptSnapshot
    {
        ...
        /// </summary>
        /// <remarks>
        /// Sem escopo nenhum (<c>recurso#</c>), a pergunta é sobre o recurso inteiro: basta ele
        /// estar no retrato. Com escopos, o modo de validação decide entre exigir todos ou qualquer
        /// um — exatamente o que o <c>ScopesValidationMode</c> significava quando quem avaliava era
        /// o servidor.
        /// </remarks>
        ...
        /// <summary>Quais dos escopos pedidos o retrato concede sobre o recurso.</summary>
