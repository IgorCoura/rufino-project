...
namespace PeopleManagement.API.Authorization
{
    ...
    /// <summary>
    /// Resolve a permissao do endpoint contra o retrato de permissoes do token.
    /// </summary>
    /// <remarks>
    /// Desde 2026-09-04 nao fala com o Keycloak: pede o retrato ao <see cref="IRptCache"/>, que o
    /// busca UMA vez por token. A traducao de desfecho continua identica — token recusado vira 401
    /// e servidor fora do ar vira 503, em vez de os dois colapsarem no 403 padrao.
    /// </remarks>
