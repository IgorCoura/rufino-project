...
namespace PeopleManagement.Infra.Migrations
{
    ...
    [Migration("20260811215801_RenameExpirationCountToRenewalCount")]
    partial class RenameExpirationCountToRenewalCount
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PeopleManagement.Domain.AggregatesModel.DocumentAggregate.DocumentUnit", b =>
                {
                    ...
                    b.Property<string>("AttachmentToken")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");
                    ...
                    b.Property<Guid?>("ReplacesDocumentUnitId")
                        .HasColumnType("uuid");

                    b.Property<DateTime?>("SentToSignatureAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("PeopleManagement.Domain.AggregatesModel.DocumentTemplateAggregate.DocumentTemplate", b =>
                {
                    ...
                    b.Property<bool>("UsePreviousPeriod")
            ...
            modelBuilder.Entity("PeopleManagement.Domain.AggregatesModel.EmployeeAggregate.Employee", b =>
                {
                    ...
                    b.Property<int>("DocumentRepresentingStatus")
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("SocialIntegrationProgram")
                        .HasMaxLength(11)
            ...
            modelBuilder.Entity("PeopleManagement.Domain.AggregatesModel.DocumentAggregate.DocumentUnit", b =>
                {
                    ...
                    b.OwnsOne("PeopleManagement.Domain.AggregatesModel.DocumentAggregate.Period", "Period", b1 =>
                        {
