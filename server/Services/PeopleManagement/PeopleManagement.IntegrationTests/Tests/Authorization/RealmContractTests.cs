...
namespace PeopleManagement.IntegrationTests.Tests.Authorization
{
    ...
    /// declara TEM que existir no <c>people-management-authz-config.json</c> versionado.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    /// <c>archive-category</c> aqui, e com o <c>"Archive"</c> escrito com A maiúsculo:
    ...
    public sealed class RealmContractTests(PeopleManagementWebApplicationFactory factory) : BaseIntegrationTest(factory)
    {
        private const string AUTHZ_CONFIG_PATH = "KeycloakConfig/people-management-authz-config.json";
