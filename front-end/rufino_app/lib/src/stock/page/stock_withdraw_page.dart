...
import 'package:rufino_app/src/stock/components/finished_order_dialog.dart';
...
class StockWithdrawPage extends StatelessWidget {
  final TextEditingController controller = TextEditingController();
  StockWithdrawPage({Key? key}) : super(key: key);
