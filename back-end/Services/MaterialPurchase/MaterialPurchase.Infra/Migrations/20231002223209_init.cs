        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AddressCountry = table.Column<string>(name: "Address_Country", type: "character varying(50)", maxLength: 50, nullable: true),
                    AddressZipCode = table.Column<string>(name: "Address_ZipCode", type: "character varying(16)", maxLength: 16, nullable: true),
                    DeliveryAddressStreet = table.Column<string>(name: "DeliveryAddress_Street", type: "character varying(50)", maxLength: 50, nullable: true),
                    DeliveryAddressCity = table.Column<string>(name: "DeliveryAddress_City", type: "character varying(50)", maxLength: 50, nullable: true),
                    DeliveryAddressState = table.Column<string>(name: "DeliveryAddress_State", type: "character varying(50)", maxLength: 50, nullable: true),
                    DeliveryAddressCountry = table.Column<string>(name: "DeliveryAddress_Country", type: "character varying(50)", maxLength: 50, nullable: true),
                    DeliveryAddressZipCode = table.Column<string>(name: "DeliveryAddress_ZipCode", type: "character varying(16)", maxLength: 16, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FunctionId", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CompanyPermissions_Constructions_ConstructionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaymentDescription = table.Column<string>(type: "character varying(250)", maxLength: 250, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FunctionIdRole_FunctionId_FunctionsIdsId",
                        column: x => x.FunctionsIdsId,
                        principalTable: "FunctionId",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompanyPermissionId = table.Column<Guid>(type: "uuid", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UsePermissions_CompanyPermissions_CompanyPermissionId",
                        column: x => x.CompanyPermissionId,
                        principalTable: "CompanyPermissions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UsePermissions_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                name: "FunctionIdPermissions",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Name = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    UsePermissionId = table.Column<Guid>(type: "uuid", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FunctionIdPermissions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FunctionIdPermissions_UsePermissions_UsePermissionId",
                        column: x => x.UsePermissionId,
                        principalTable: "UsePermissions",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompanyPermissions_ConstructionId",
                table: "CompanyPermissions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FunctionId_Name",
                table: "FunctionId",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_FunctionIdPermissions_UsePermissionId",
                table: "FunctionIdPermissions",
                column: "UsePermissionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsePermissions_CompanyPermissionId",
                table: "UsePermissions",
                column: "CompanyPermissionId");

            migrationBuilder.CreateIndex(
                name: "IX_UsePermissions_UserId",
                table: "UsePermissions",
                column: "UserId");
        }
